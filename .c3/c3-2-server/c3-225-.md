---
id: c3-225
c3-seal: 1c0a324f2a81b8cefc45433de521c19f3cc74879f3e2b4cb0767ab37927afc58
...
| src/server/claude-pty/driver.test.ts | Contract and Change Safety | Test cases per surface | src/server/claude-pty/driver.test.ts |
| src/server/claude-pty/tui-control.test.ts | Contract and Change Safety | Dialog dismissal + reference-guard coverage | src/server/claude-pty/tui-control.test.ts |
| src/server/claude-pty/pty-cli-args.test.ts | Contract and Change Safety | Channel flag presence/absence per session kind | src/server/claude-pty/pty-cli-args.test.ts |
| src/server/claude-pty/pty-memory-sampler.adapter.test.ts | Contract and Change Safety | Parser + tree-collect + integration coverage for sampler | src/server/claude-pty/pty-memory-sampler.adapter.test.ts |
