---
id: c3-229
c3-seal: eaaf7d7f3303a18d04fad3c63c92883302d807f69057082a0735dfcd97f3a3df
...
| src/server/workflow-agent-transcript-io.adapter.test.ts | Contract and Change Safety | Missing-file, prefixed-agentId, and line-split coverage | src/server/workflow-agent-transcript-io.adapter.test.ts |
...
| src/client/app/WorkflowAgentTranscriptPanel.test.tsx | Contract and Change Safety | Transcript fetch + render coverage | src/client/app/WorkflowAgentTranscriptPanel.test.tsx |
...
| src/shared/workflow-types.test.ts | Contract and Change Safety | parseWorkflowRunFile and toRunSummary coverage | src/shared/workflow-types.test.ts |
