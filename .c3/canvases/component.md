---
id: component
c3-seal: a040a4619c3cc34f1bb3b9f56790b1ef1e669d8a6fccddc15e03ae48db258069
type: canvas
...
sections:
    ...
    - name: Change Safety
      ...
      columns:
        ...
        - name: Required Verification
          type: evidence
      min_rows: 2
    - name: Chat Op-Log (delta broadcast source)
      content_type: text
      required: false
      purpose: Component-specific implementation detail (see adr-20260810-component-implementation-notes)
      min_words: 12
    - name: Transcript cache
      ...
      purpose: Component-specific implementation detail (see adr-20260810-component-implementation-notes)
      min_words: 12
    - name: Transcript tail-read (cold-open fast path)
      content_type: text
      required: false
      purpose: Component-specific implementation detail (see adr-20260810-component-implementation-notes)
      min_words: 12
    - name: chat.ops delta broadcast
      content_type: text
      required: false
      purpose: Component-specific implementation detail (see adr-20260810-component-implementation-notes)
      min_words: 12
    - name: Chat ops delta events
      content_type: text
      required: false
      purpose: Component-specific implementation detail (see adr-20260810-component-implementation-notes)
      min_words: 12
