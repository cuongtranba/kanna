...
## Baseline (measured 2026-07-12, ast-grep `useState($$$)`)

- **144 total call sites** in `src/client/` (128 in `.tsx`, 16 in `.ts`)
- **139 in-scope call sites across 44 files** after allowlist exclusions
- Top hotspots: `SettingsPage.tsx` (18), `RightSidebar.tsx` (17),
  `McpServersSection.tsx` (13), `useKannaState.ts` (9), `ChatPage/index.tsx` (8),
  `KannaSidebar.tsx` (7)
