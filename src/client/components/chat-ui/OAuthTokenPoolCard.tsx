    ...
    <div className="flex items-center justify-between gap-3 border-t border-border py-3">
      ...
      <div className="min-w-0 flex-1">
        <div className="flex items-center gap-3">
          ...
          {isCurrent && (
            <span className="inline-flex shrink-0 items-center whitespace-nowrap rounded-full border border-primary/40 bg-primary/10 px-1.5 py-0.5 text-10 font-medium uppercase tracking-wide text-primary">
              In use
            </span>
          )}
        </div>
