...
function StatusPill({ phase }: { phase: PtyInstancePhase }) {
  return (
    <span
      className="inline-flex items-center gap-1.5 px-1.5 py-0.5 rounded-full text-xs font-mono tracking-wide tabular-nums"
...
function PtyInstanceRowContent({ instance, onOpenChat, onCancel, onKill }: RowProps) {
  ...
  return (
    <div className="group border border-border/60 rounded-lg p-3 flex flex-col gap-2 hover:border-border transition-colors">
      ...
      <div className="grid grid-cols-2 gap-x-3 gap-y-1 text-xs text-muted-foreground font-mono tabular-nums">
    ...
    <Popover open={open} onOpenChange={onOpenChange}>
      ...
      <PopoverContent align="end" sideOffset={8} className="w-[420px] p-3">
        <div className="flex items-center justify-between mb-3">
          <h3 className="text-xs font-mono tracking-wider text-foreground/60">
