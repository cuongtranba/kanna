...
/**
 * `muted` is never a chat STATUS — no status is quiet-but-present. It exists
 * for scheduled work (a card's armed cron job), which has to be visible without
 * claiming attention the way amber does.
 */
