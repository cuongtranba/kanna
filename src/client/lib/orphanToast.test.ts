...
describe("fireOrphanRecoveryToast", () => {
  ...
  test("second call still fires the toast (session-once guard is caller-owned)", () => {
    fireOrphanRecoveryToast(1)
    fireOrphanRecoveryToast(1)
